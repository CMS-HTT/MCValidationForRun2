...
histograms_properties['h1_tt_tau1_eta'] = ['h1_tt_tau1_eta', '',  20, -  6  ,   6  , '#tau_{h}#tau_{h} channel - #eta_{#tau_{1}} [GeV]' ,]
histograms_properties['h1_tt_tau1_phi'] = ['h1_tt_tau1_phi', '',  20, -  4  ,   4  , '#tau_{h}#tau_{h} channel - #phi_{#tau_{1}} [GeV]' ,]
histograms_properties['h1_tt_tau2_pt' ] = ['h1_tt_tau2_pt' , '',  20,    0  , 200  , '#tau_{h}#tau_{h} channel - p_{T}^{#tau_{2}} [GeV]',]
histograms_properties['h1_tt_tau2_eta'] = ['h1_tt_tau2_eta', '',  20, -  6  ,   6  , '#tau_{h}#tau_{h} channel - #eta_{#tau_{2}} [GeV]' ,]
histograms_properties['h1_tt_tau2_phi'] = ['h1_tt_tau2_phi', '',  20, -  4  ,   4  , '#tau_{h}#tau_{h} channel - #phi_{#tau_{2}} [GeV]' ,]

histograms_properties['h1_mt_mu_pt'   ] = ['h1_mt_mu_pt'   , '',  20,    0  , 200  , '#mu#tau_{h} channel - p_{T}^{#mu} [GeV]'          ,]
histograms_properties['h1_mt_mu_eta'  ] = ['h1_mt_mu_eta'  , '',  20, -  6  ,   6  , '#mu#tau_{h} channel - #eta_{#mu} [GeV]'           ,]
histograms_properties['h1_mt_mu_phi'  ] = ['h1_mt_mu_phi'  , '',  20, -  4  ,   4  , '#mu#tau_{h} channel - #phi_{#mu} [GeV]'           ,]
histograms_properties['h1_mt_tau_pt'  ] = ['h1_mt_tau_pt'  , '',  20,    0  , 200  , '#mu#tau_{h} channel - p_{T}^{#tau} [GeV]'         ,]
histograms_properties['h1_mt_tau_eta' ] = ['h1_mt_tau_eta' , '',  20, -  6  ,   6  , '#mu#tau_{h} channel - #eta_{#tau} [GeV]'          ,]
histograms_properties['h1_mt_tau_phi' ] = ['h1_mt_tau_phi' , '',  20, -  4  ,   4  , '#mu#tau_{h} channel - #phi_{#tau} [GeV]'          ,]

histograms_properties['h1_et_ele_pt'  ] = ['h1_et_ele_pt'  , '',  20,    0  , 200  , 'e#tau_{h} channel - p_{T}^{e} [GeV]'              ,]
histograms_properties['h1_et_ele_eta' ] = ['h1_et_ele_eta' , '',  20, -  6  ,   6  , 'e#tau_{h} channel - #eta_{e} [GeV]'               ,]
histograms_properties['h1_et_ele_phi' ] = ['h1_et_ele_phi' , '',  20, -  4  ,   4  , 'e#tau_{h} channel - #phi_{e} [GeV]'               ,]
histograms_properties['h1_et_tau_pt'  ] = ['h1_et_tau_pt'  , '',  20,    0  , 200  , 'e#tau_{h} channel - p_{T}^{#tau} [GeV]'           ,]
histograms_properties['h1_et_tau_eta' ] = ['h1_et_tau_eta' , '',  20, -  6  ,   6  , 'e#tau_{h} channel - #eta_{#tau} [GeV]'            ,]
histograms_properties['h1_et_tau_phi' ] = ['h1_et_tau_phi' , '',  20, -  4  ,   4  , 'e#tau_{h} channel - #phi_{#tau} [GeV]'            ,]

histograms_properties['h1_em_mu_pt'   ] = ['h1_em_mu_pt'   , '',  20,    0  , 200  , 'e#mu channel - p_{T}^{#mu} [GeV]'                 ,]
histograms_properties['h1_em_mu_eta'  ] = ['h1_em_mu_eta'  , '',  20, -  6  ,   6  , 'e#mu channel - #eta_{#mu} [GeV]'                  ,]
histograms_properties['h1_em_mu_phi'  ] = ['h1_em_mu_phi'  , '',  20, -  4  ,   4  , 'e#mu channel - #phi_{#mu} [GeV]'                  ,]
histograms_properties['h1_em_ele_pt'  ] = ['h1_em_ele_pt'  , '',  20,    0  , 200  , 'e#mu channel - p_{T}^{e} [GeV]'                   ,]
histograms_properties['h1_em_ele_eta' ] = ['h1_em_ele_eta' , '',  20, -  6  ,   6  , 'e#mu channel - #eta_{e} [GeV]'                    ,]
histograms_properties['h1_em_ele_phi' ] = ['h1_em_ele_phi' , '',  20, -  4  ,   4  , 'e#mu channel - #phi_{e} [GeV]'                    ,]

histograms_properties['h1_mm_mu1_pt'  ] = ['h1_mm_mu1_pt'  , '',  20,    0  , 200  , '#mu#mu channel - p_{T}^{#mu_{1}} [GeV]'           ,]
histograms_properties['h1_mm_mu1_eta' ] = ['h1_mm_mu1_eta' , '',  20, -  6  ,   6  , '#mu#mu channel - #eta_{#mu_{1}} [GeV]'            ,]
histograms_properties['h1_mm_mu1_phi' ] = ['h1_mm_mu1_phi' , '',  20, -  4  ,   4  , '#mu#mu channel - #phi_{#mu_{1}} [GeV]'            ,]
histograms_properties['h1_mm_mu2_pt'  ] = ['h1_mm_mu2_pt'  , '',  20,    0  , 200  , '#mu#mu channel - p_{T}^{#mu_{2}} [GeV]'           ,]
histograms_properties['h1_mm_mu2_eta' ] = ['h1_mm_mu2_eta' , '',  20, -  6  ,   6  , '#mu#mu channel - #eta_{#mu_{2}} [GeV]'            ,]
histograms_properties['h1_mm_mu2_phi' ] = ['h1_mm_mu2_phi' , '',  20, -  4  ,   4  , '#mu#mu channel - #phi_{#mu_{2}} [GeV]'            ,]
...
histograms_properties['h1_ee_ele2_eta'] = ['h1_ee_ele2_eta', '',  20, -  6  ,   6  , 'ee channel - #eta_{e_{2}} [GeV]'                  ,]
histograms_properties['h1_ee_ele2_phi'] = ['h1_ee_ele2_phi', '',  20, -  4  ,   4  , 'ee channel - #phi_{e_{2}} [GeV]'                  ,]
